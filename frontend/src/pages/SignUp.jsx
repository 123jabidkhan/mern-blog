  ...
  return (
    <>
      <section className="min-h-screen flex items-stretch text-white ">
        ...
        >
          <div className="absolute bg-[#008a008f] opacity-85 inset-0 z-0"></div>
        ...
        <div
          ...
          style={{ backgroundColor:'rgb(0 138 0 / 29%)'}}
        >
          <div
          ...
          <div className="w-full py-4 z-20">
            ...
            <input
              ...
              <div className="px-4 pb-2 pt-4">
                <button type="submit" className="uppercase block w-full p-3 text-lg rounded-full bg-[#d30617] hover:bg-[#eb3f4d] focus:outline-none">
                <span className="ml-3 text-light-100">
                      {loading ? (
                         <>
                           <Spinner size="sm" />
